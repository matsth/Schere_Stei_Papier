...
while running:
    ...
    if (time.time() >= t_end):
        ...
        if(resultMachine == 0):
            ...
            error = 1
            resultMachinetext = 'Keine eingabe!'
        ...
        if (error < 1):
            match aichoice:
                case 0:
                    match userchoice:
                        case 0:
                            result = 'Du wahlst ' + numbertonamearr[userchoice] + ', KI wahlt ' + numbertonamearr[aichoice] + ' unentschieden!'
                            moveused[userchoice] += 1
                            draws += 1
                            AIlearning(learningfactordraw)
                        case 1:
                            result = 'Du wahlst ' + numbertonamearr[userchoice] + ', KI wahlt ' + numbertonamearr[aichoice] + ' Du gewinnst!'
                            moveused[userchoice] += 1
                            playerWins += 1
                            lastwon = userchoice
                            AIlearning(learningfactorlose)
                        case 2:
                            result = 'Du wahlst ' + numbertonamearr[userchoice] + ', KI wahlt ' + numbertonamearr[aichoice] + ' KI gewinnst!'
                            moveused[userchoice] += 1
                            aiWins += 1
                            lastwon = aichoice
